...
final class MscRuleSeeder extends Seeder
{
    ...
    private function rules(): array
    {
        return [
            ...
            [
                'code' => 'D2_00001',
                'name' => 'Informação da variação patrimonial aumentativa do FUNDEB no Anexo I-HI da DCA.',
                'validation_type' => MscRuleValidationType::Global,
                'target_group' => 'DCA — Anexo I-HI (Demonstrativo das Variações Patrimoniais)',
                'objective' => 'Verifica se o valor declarado para a variação patrimonial aumentativa com o FUNDEB no Anexo I-HI da DCA é maior que zero, aplicando-se exclusivamente no período de encerramento (13).',
                'error_message' => 'não foi informado, no Anexo I-HI da DCA, valor da variação patrimonial aumentativa com o FUNDEB.',
                'is_implemented' => true,
            ],
            [
                'code' => 'D2_00002',
                'name' => 'Informação da variação patrimonial diminutiva do FUNDEB no Anexo I-HI da DCA.',
                'validation_type' => MscRuleValidationType::Global,
                'target_group' => 'DCA — Anexo I-HI (Demonstrativo das Variações Patrimoniais)',
                'objective' => 'Verifica se o valor declarado para a variação patrimonial diminutiva com o FUNDEB no Anexo I-HI da DCA é maior que zero, aplicando-se exclusivamente no período de encerramento (13).',
                'error_message' => 'não foi informado, no Anexo I-HI da DCA, valor da variação patrimonial diminutiva com o FUNDEB.',
                'is_implemented' => true,
            ],
            [
                'code' => 'D1_00017',
