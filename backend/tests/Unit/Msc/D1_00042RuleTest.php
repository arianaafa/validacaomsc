...
final class D1_00042RuleTest extends TestCase
{
    private D1_00042Rule $rule;

    protected function setUp(): void
    {
        parent::setUp();

        $this->rule = new D1_00042Rule();
    }

    public function test_rejeita_despesa_educacao_sem_co(): void
    {
        ...
        $this->assertSame(
            'despesa com manutenção e desenvolvimento do ensino sem o código de acompanhamento orçamentário (CO) específico.',
            $result,
        );
        $this->assertSame('D1_00042', $this->rule->getCode());
    }

    public function test_rejeita_despesa_educacao_com_co_generico_0000(): void
    {
        $result = $this->rule->validate($this->lineData(
            conta: '631100000',
            valor: 800.0,
    ...
    public function test_aceita_despesa_educacao_com_co_valido(): void
    {
        $result = $this->rule->validate($this->lineData(
            conta: '622130000',
            valor: 1500.0,
    ...
    public function test_ignora_despesa_com_funcao_diferente_de_educacao(): void
    {
        $result = $this->rule->validate($this->lineData(
            conta: '622130000',
            valor: 1500.0,
