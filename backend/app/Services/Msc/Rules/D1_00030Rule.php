...
final class D1_00030Rule implements MscRuleInterface
{
    private const CODE = 'D1_00030';

    private const IC_NATUREZA_RECEITA = 'NR';

    private const MENSAGEM_INCONSISTENCIA = 'contas de receita orçamentária e deduções sem o detalhamento de natureza de receita.';
    ...
    /**
     * Contas dos grupos 6211, 6212 e 6213 exigem detalhamento de Natureza de Receita (NR).
     */
    public function validate(MscLineData $lineData): ?string
    {
        ...
        $naturezaReceita = trim($icMap[self::IC_NATUREZA_RECEITA] ?? '');
