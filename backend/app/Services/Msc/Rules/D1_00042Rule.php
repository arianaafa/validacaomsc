...
final class D1_00042Rule implements MscRuleInterface
{
    private const CODE = 'D1_00042';
    ...
    private const FUNCAO_EDUCACAO = '12';

    private const CO_GENERICO_ZERADO = '0000';

    private const MENSAGEM_INCONSISTENCIA = 'despesa com manutenção e desenvolvimento do ensino sem o código de acompanhamento orçamentário (CO) específico.';
    ...
    /**
     * Despesas de Educação (função 12) nas contas 62 e 63 com saldo final não zerado
    ...
    public function validate(MscLineData $lineData): ?string
    {
        ...
        if (! $this->isFuncaoEducacao($icMap[self::IC_FUNCAO_SUBFUNCAO] ?? '')) {
            return null;
        }
    ...
    private function isFuncaoEducacao(string $funcaoSubfuncao): bool
    {
        ...
        return $funcao === self::FUNCAO_EDUCACAO;
    }
