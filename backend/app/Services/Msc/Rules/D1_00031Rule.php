...
final class D1_00031Rule implements MscRuleInterface
{
    private const CODE = 'D1_00031';

    private const IC_NATUREZA_DESPESA = 'ND';

    private const PREFIXO_CONTA_DESPESA = '62213';

    private const MENSAGEM_INCONSISTENCIA = 'contas de despesa orçamentária sem o detalhamento de natureza de despesa.';
    ...
    /**
     * Contas do grupo 62213 exigem detalhamento de Natureza de Despesa (ND).
     */
    public function validate(MscLineData $lineData): ?string
    {
        ...
        $naturezaDespesa = trim($icMap[self::IC_NATUREZA_DESPESA] ?? '');
